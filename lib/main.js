...
$(document).ready(function(){
	...
	$.ajax({
		...
		error: function(e){console.log('Error accediendo a la url: '+appremoteurl);console.log(e);}
	});
...
xmlhttp.onreadystatechange=function(){
	if (xmlhttp.readyState==4 && xmlhttp.status==200){
		...
		alert(JSONObject.newversion);
	}
}
xmlhttp.open("GET","http://www.torzap.com.mx/apps/Class/version.json",true);
xmlhttp.send();
});
